        ...
        <div class="row mar-top">
          <div class="col-md-3">
            ...
            <div class="row mar-top">
              <div class="col-sm-5">
                <div class="text-lg">
                  <p class="text-5x text-thin text-main mar-no">4</p>
                </div>
              ...
              <div class="col-sm-7">
                <div class="list-group bg-trans mar-no">
                  <a class="list-group-item" href="#">
                    <i class="demo-pli-information icon-lg icon-fw"></i> User Details
                  </a>
                  <a class="list-group-item" href="#">
                  ...
                  >
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a class="btn-link" href="#">Patrick Ryan Cutor</a>
                        </td>
                        <td>patjun007@gmail.com</td>
                        <td>
                          <span class="label label-table label-purple">Admin</span>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="label label-table label-info">Salesman</span>
                        </td>
                        <td>
                          <div class="btn-group dropdown">
                            <button
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn-link" href="#">Maria Marz</a>
                        </td>
                        <td>maria_545@example.com</td>
                        <td>
                          <span class="label label-table label-success">Customer</span>
                        </td>
                        <td>
                          <div class="btn-group dropdown">
                            <button
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn-link" href="#">Joseph Santos</a>
                        </td>
                        <td>sotnas05@example.com</td>
                        <td>
                          <span class="label label-table label-danger">Supervisor</span>
                        </td>
                        <td>
                          <div class="btn-group dropdown">
                            <button
      ...
      <div class="panel-body">
        <div class="row mar-top">
          ...
          <div class="col-md-12">
            <div class="panel">
              <div class="panel-heading">
                <h3 class="text-main text-normal text-2x mar-no">Top Customers (Supervisor)</h3>
              </div>
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-4 col-md-3">
                    ...
                    <div class="panel pos-rel">
                      ...
                      <div class="pad-all">
                        ...
                        <p
                          class="pad-btm bord-bt text-sm"
                        >Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean massa.</p>
                        <div class="text-center pad-to">
                          <div class="btn-group">
                            <a href="#" class="btn btn-sm btn-default">
                              <i class="demo-pli-consulting icon-lg icon-fw"></i> Call
                            </a>
                            <a href="#" class="btn btn-sm btn-default">
        ...
        <div class="row mar-top">
          ...
          <div class="col-md-12">
            <div class="panel">
              <div class="panel-heading">
                <h3 class="text-main text-normal text-2x mar-no">Top Salesmans (Supervisor)</h3>
              </div>
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-4 col-md-3">
        ...
        <div class="row mar-top">
          ...
          <div class="col-md-12">
            <div class="panel">
              <div class="panel-heading">
                <h3 class="text-main text-normal text-2x mar-no">Top Items (Supervisor)</h3>
              </div>
              <div class="panel-body">
                <div class="row">
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                        <tr>
                          <td class="min-w-td">1</td>
                          <td>
                            <a class="btn-link" href="#">BW BAKING CUP WHITE GLAZZINE 2oz</a>
                          </td>
                          <td>100053</td>
                          <td>BW BAKING CUP</td>
                        ...
                        <tr>
                          <td class="min-w-td">3</td>
                          <td>
                            <a class="btn-link" href="#">NAVY CLUB FILTER KING 500s</a>
                          </td>
                          <td>100451</td>
                          <td>NAVY CLUB</td>
                          <td>ASSOC.ANGLO-AMER.TOBACO CORP.</td>
          ...
          <div class="panel-body">
            <div class="pad-btm form-inline">
              <div class="panel-heading">
                <h3
                  class="text-main text-normal text-2x mar-no"
                >Order &amp; Tracking Delivery (Supervisor)</h3>
              </div>
              <div class="row">
                <div class="col-sm-12 table-toolbar-right">
                  <button class="btn btn-default">
      ...
      <div class="col-md-12">
        <div class="panel">
          ...
          <div class="panel-body">
            <div class="row mar-top">
              <div class="col-md-3">
                <h3 class="text-main text-normal text-2x mar-no">Salesman (Supervisor)</h3>
                <h5 class="text-uppercase text-muted text-normal">Report for last 7-days ago</h5>
                <hr class="new-section-xs" />
                <div class="row mar-top">
                  <div class="col-sm-5">
